...
class ConnectionStateMachine:
    ...
    def draw_state_machine(self):
        ...
        nx.draw(G, pos, with_labels=True, node_size=2000, node_color="orange", font_size=10, font_color="black", font_weight="bold", edge_color="blue", width=2, style="dashed", alpha=0.9)
    ...
    def draw_transition(self):
        ...
        machine = GraphMachine(model=self, graph_engine="graphviz", states=ConnectionStateMachine.states, transitions=transitions, initial="requested", title="Connection State Machine", show_conditions=True)
